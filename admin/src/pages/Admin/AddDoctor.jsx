...
const AddDoctor = () => {
    ...
    const [speciality, setSpeciality] = useState('NeuroMuscular Consultant')
    ...
    return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                <option value="NeuroMuscular Consultant">NeuroMuscular Consultant</option>
                                <option value="Head & Neck Cancer Specialist">Head & Neck Cancer Specialist</option>
                ...
                <button type='submit' className='bg-gradient-to-r from-red-500 to-pink-500 px-10 py-3 mt-4 text-white rounded-full'>Add doctor</button>
