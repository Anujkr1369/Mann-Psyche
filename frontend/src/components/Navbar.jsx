...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-[#ADADAD] sticky top-0 bg-white z-50'>
      <img onClick={() => navigate('/')} className="w-30 h-20 object-contain cursor-pointer" src={assets.anlogo} alt="" />
      <ul className='md:flex items-start gap-5 font-medium hidden'>
        ...
        <button
          ...
          className='bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 py-2 rounded-full font-medium transition-all shadow-lg hover:bg-blue-700 ml-4'
